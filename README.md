...
This repository contains the run_analysis.R script to create the tidy dataset and the codebook with descriptions of the data (raw & tidy) and the changes made by the r script
